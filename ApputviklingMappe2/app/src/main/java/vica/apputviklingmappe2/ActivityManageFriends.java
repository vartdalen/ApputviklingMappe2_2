...
public class ActivityManageFriends extends Activity {
    ...
    private void setupFields() {
        ...
        buttonDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    if (friendList.getItemAtPosition(selectedItemIndex) != null) {
                        db.deleteFriend(ActivityManageFriends.this, helper.stringParser(friendList.getItemAtPosition(selectedItemIndex).toString()));
                        friendListArray.remove(friendList.getItemAtPosition(selectedItemIndex).toString());
                    }
                    listAdapter.notifyDataSetChanged();
